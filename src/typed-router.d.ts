...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/ctViewerPage': RouteRecordInfo<'/ctViewerPage', '/ctViewerPage', Record<never, never>, Record<never, never>>,
    '/detection': RouteRecordInfo<'/detection', '/detection', Record<never, never>, Record<never, never>>,
    '/dicomTo3D': RouteRecordInfo<'/dicomTo3D', '/dicomTo3D', Record<never, never>, Record<never, never>>,
